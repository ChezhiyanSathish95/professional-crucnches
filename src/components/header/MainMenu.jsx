        ...
        <>
            <div className={`collapse navbar-collapse collapse-mobile ${isOpen ? "show" : ""}`} id="navbar-menu">
                ...
                <ul className="nav navbar-nav navbar-center">
                    ...
                    <li className='contact-new'><Link to="/">Home</Link></li>
                    <li className='contact-new'><Link to="/about-us">About us</Link></li>
                    <li className='contact-new'><Link to="/services">Services</Link></li>
                    <li className='contact-new'><Link to="/contact-us">contact</Link></li>
                    <li className='contact-new'><Link to="/register">Register</Link></li>
                </ul>
            </div>
        </>
    );

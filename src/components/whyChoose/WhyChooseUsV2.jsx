                    ...
                    <div className="row">
                        <div className="col-xl-4">
                            <div className="choose-us-style-two">
                                <h2 className="title mb-50">Delivering Market Insights That Drive Success
                                </h2>
                            ...
                            <div className="choose-us-style-two-thumb">
                                <div className="curve-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" version="1.1">
                                        ...
                                        <text><textPath href="#textPath">- Professional Crunches - Real solutions</textPath></text>
                                    </svg>
                                </div>
                                <h4>We have worked for you</h4>
                                <h2 className="text-path">since 2010</h2>
